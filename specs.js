...
describe("The FQL runtime", function () {
  ...
  describe("bedrock", function () {
    ...
    it("tables can scan across all rows using `each`", function () {
      var movieTable = new Table('film-database/movies-table');
      var count = 0;
      var fightClub = null;
    ...
    it("`FQL` instances (queries) can retrieve all rows from their table", function () {
      var movieTable = new Table('film-database/movies-table');
  ...
  describe('#limit', function () {
    ...
    it("`.each` allows for stopping early by accepting a continue predicate", function () {
      var count = 0;
      movieTable.each(
        // iterator
        function (row) {
    ...
    it("`Plan` instances (plans) hold the query's continue conditions", function () {
